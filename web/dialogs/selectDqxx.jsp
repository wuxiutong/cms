...
<script type="test/javascript" src="/js/wxt/dialog/selectDqxx.js"></script>
...
<div class="bjui-pageContent">
  ...
  <div class="zregionBackground left">
    <ul id="AllRegionForDialog" class="ztree"></ul>
  </div>
    </td>
      ...
      <div>
           <table class="table_form" style="border: none">
            ...
            <tr>
              ...
              <td>
                <p>
                  <input name="postcode" readonly="readonly"  id="postcode" class="text" type="text" size="20"
                         value=""/>
                </p>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td><p>
                <input class="readonly"  readonly="readonly"  size="20" id="fzrXm" readonly="readonly"type="text"/>
              </p>
              </td>
            </tr>
            <tr>
