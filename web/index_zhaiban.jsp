...
<div id="bjui-window">
  <header id="bjui-header">
    ...
    <nav id="bjui-navbar-collapse">
      <ul class="bjui-navbar-right">
        ...
        <li><a href="index_.jsp" title="切换为树状导航(宽版)" style="background-color:#ff7b61;">树状导航栏(宽版)</a></li>
    ...
    <div id="bjui-hnav">
      ...
      <div id="bjui-hnav-navbar-box">
        <ul id="bjui-hnav-navbar">
          ...
          <li>
            <a href="javascript:;" data-toggle="slidebar"><i class="fa fa-database"></i> 综合应用</a>
            <div class="items hide" data-noinit="true">
              <ul class="menu-items" data-faicon="database">
                ...
                <li><a href="basic/region.jsp" data-options="{id:'region', faicon:'th-large'}">地区管理</a></li>
                <li><a href="basic/bloc.jsp" data-options="{id:'bloc', faicon:'th-large'}">客户类型</a></li>
                <li><a href="basic/bloc.jsp" data-options="{id:'bloc', faicon:'th-large'}">销售单位</a></li>
                <li><a href="staff/bmzy.jsp" data-options="{id:'bmzy', faicon:'th-large'}">职员信息</a></li>
                <li><a href="soft/soft.jsp" data-options="{id:'soft', faicon:'th-large'}">软件信息</a></li>
              </ul>
            </div>
          </li>
  ...
  <footer id="bjui-footer">Copyright &copy; 2013 - 2015　<a href="http://www.cdjinyang.com/" target="_blank">贵州云尚科技</a>　
    <!--
