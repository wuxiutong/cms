 ...
 */
//选择事件
function S_NodeCheck_rpt_whrq_init(e, treeId, treeNode) {
...
//初始化地区信息供选择，
function initDqxxZtreeForRptWhrq_init() {
    var setting = {
        data: {
            simpleData: {
                enable: true,
...
//        beforeClick: zTreeBeforeClick,
            onCheck: S_NodeCheck_rpt_whrq_init,
//        onDblClick: zTreeOnDblClick
    ...
    $.fn.zTree.init($("#AllRegionForZtreeRptWhrqInit"), setting)
}
 
//初始化客户经理信息供选择，
function initKhjlForZtreeForWhrqInit() {
    var setting = {
        data: {
            simpleData: {
                enable: true,
...
//        onDblClick: zTreeOnDblClick
    ...
    $.fn.zTree.init($("#AllKhjlForWhrqInit"), setting)
}
//初始化地区信息用于客户筛选
initDqxxZtreeForRptWhrq_init();
//初始化客户经理信息用于客户筛选
initKhjlForZtreeForWhrqInit();
$.CurrentNavtab.find("#searchBtn").bind("click", function () {
    ...
    var url = 'Get_RPT_KhxxForInitWHRQ?khjl=' + khjl + "&keyword=" + keyword + "&dqxx=" + dqxx ;
