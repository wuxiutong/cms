 ...
 */
//选择事件
function S_NodeCheck_rpt_dwysk(e, treeId, treeNode) {
...
//        onDblClick: zTreeOnDblClick
    ...
    $.fn.zTree.init($("#AllRegionForRptDWYSK"), setting)
}

//初始化客户信息供选择，
function initKhlx_rpt_dwysk() {
    var setting = {
        data: {
            simpleData: {
                enable: true,
...
//        onDblClick: zTreeOnDblClick
    ...
    $.fn.zTree.init($("#AllKhlxForRptDWYSK"), setting)
}
//初始化客户经理信息供选择，
function initKhjl_rpt_dwysk() {
    var setting = {
        data: {
            simpleData: {
                enable: true,
...
//        onDblClick: zTreeOnDblClick
    ...
    $.fn.zTree.init($("#AllKhjlForRptDWYSK"), setting)
}
//初始化销售公司信息供选择，
function initXsgs_rpt_dwysk() {
    var setting = {
        data: {
            simpleData: {
                enable: true,
...
//        onDblClick: zTreeOnDblClick
    ...
    $.fn.zTree.init($("#AllXsgsForRptDWYSK"), setting)
}
//初始化使用软件信息供选择，
function initSoft_rpt_dwysk() {
    var setting = {
        data: {
            simpleData: {
                enable: true,
...
//        onDblClick: zTreeOnDblClick
    ...
    $.fn.zTree.init($("#AllSoftForRptDWYSK"), setting)
}
//初始化地区信息用于客户筛选
initDqxx_rpt_dwysk();
//初始化客户经理信息用于客户筛选
...
$.CurrentNavtab.find("#searchBtn").bind("click", function () {
    ...
    var url = 'Get_RPT_DWYSK?dqxx=' + dqxx + "&kjnd=" + kjnd + "&khjl=" + khjl + "&keyword=" + keyword;
    $($.CurrentNavtab.find("#datatable_rpt_dwysk")).datagrid('refreshByUrl', url);
