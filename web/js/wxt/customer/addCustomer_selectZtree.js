 ...
 */
//选择事件
function S_NodeCheck_cusomerAdd(e, treeId, treeNode) {
...
//职员信息选择 避免选择的是部门信息
function S_NodeCheck_Zyxx_cusomerAdd(e, treeId, treeNode) {
    var zTree = $.fn.zTree.getZTreeObj(treeId),
        nodes = zTree.getCheckedNodes(true)
    var ids = '', names = ''
...
//点击事件，点击节点后赋值，即可隐藏！
function S_NodeClick_customerAdd (event, treeId, treeNode) {
    var zTree = $.fn.zTree.getZTreeObj(treeId)
...
function initDqxx_customerAdd() {
    var setting = {
        ...
        callback: {
            onCheck: S_NodeCheck_cusomerAdd,
            onClick: S_NodeClick_customerAdd
        },
        async: {
            enable: true,
    ...
    $.fn.zTree.init($("#AllRegionForAddKhxx"), setting)
}

//初始化客户信息供选择，
function initKhlx_customerAdd() {
    var setting = {
        data: {
            simpleData: {
                enable: true,
...
function initKhjl_customerAdd() {
    var setting = {
        ...
        callback: {
            onCheck: S_NodeCheck_Zyxx_cusomerAdd,
    ...
    $.fn.zTree.init($("#AllKhjlForAddKhxx"), setting)
}
//初始化销售公司信息供选择，
function initxsgs_customerAdd() {
    var setting = {
        data: {
            simpleData: {
                enable: true,
...
//初始化地区信息用于客户筛选
initDqxx_customerAdd();
//初始化客户经理信息用于客户筛选
initKhjl_customerAdd();
//初始化客户类型用于客户筛选
initKhlx_customerAdd();
//初始化销售公司信息用于客户筛选
initxsgs_customerAdd()
//初始化使用软件信息用于客户筛选
initSoft_customerAdd()
